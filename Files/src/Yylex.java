...
"10:9,8:2,10,8:2,10:18,8,10:9,2,10:5,9:10,10,1,10:45,5,10:4,6,10,3,10,4,10,7" +
",10:11,0:2")[0];

	private int yy_rmap[] = unpackFromString(1,12,
"0,1:3,2,1,3,1,4,1,5,6")[0];

	private int yy_nxt[][] = unpackFromString(7,11,
"1,2,3,4,9:4,5,6,9,-1:15,8,-1:15,6,-1:6,10,-1:11,11,-1:11,7,-1:3");
			...
			if (YY_F != yy_next_state) {
				...
				if (YY_NO_STATE == yy_last_accept_state) {
					...
					case -7:
						break;
					case 7:
						{ return new Symbol(sym.PRINT, null); }
					case -8:
						break;
					case 9:
						{ System.err.println("Illegal character: "+yytext()); }
